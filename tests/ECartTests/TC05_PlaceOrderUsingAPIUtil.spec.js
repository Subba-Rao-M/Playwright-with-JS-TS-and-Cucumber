...
const {APIUtils} = require('../../ECartFramework_JS/utils/APIUtils');
...
test('Login to app and place order using API methods from Util and view using Web', {tag: ['@ecart', '@api','@master', '@sanity']}, async ({page})=>{
