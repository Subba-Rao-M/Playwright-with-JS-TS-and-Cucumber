...
test('Handle Cookies Demo', async ({ browser }) => {
  ...
  test.slow();
  //Cookie is a small information saved by browser and it remembers it unless its cleared or expired
  //Cookies can be handled by browser context
  // Add a cookie
  ...
  expect(retrievedCookie).toBeDefined(); // To chcek if no undefined 
