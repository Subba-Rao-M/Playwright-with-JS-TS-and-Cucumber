...
import { RegistrationPage } from '../../OpenCartFramework/pages/RegistrationPage';
import { HomePage } from '../../OpenCartFramework/pages/HomePage';
import { RandomDataUtil } from '../../OpenCartFramework/utils/randomDataGenerator';
import { TestConfig } from '../../test.config';
import { LogoutPage } from '../../OpenCartFramework/pages/LogoutPage';
import { LoginPage } from '../../OpenCartFramework/pages/LoginPage';
import { MyAccountPage } from '../../OpenCartFramework/pages/MyAccountPage';
import { SearchResultsPage } from '../../OpenCartFramework/pages/SearchResultsPage';
import { ProductPage } from '../../OpenCartFramework/pages/ProductPage';
import { ShoppingCartPage } from '../../OpenCartFramework/pages/ShoppingCartPage';
import { CheckoutPage } from '../../OpenCartFramework//pages/CheckoutPage';

// This is the main test block that runs the entire flow
test('execute end-to-end test flow', {tag: ['@opencart', '@e2e']}, async ({ page }) => {
